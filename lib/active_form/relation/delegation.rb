    ...
    module Delegation # :nodoc:
      class << self
        def delegated_classes
          [
            ActiveForm::Relation,
            ActiveForm::Associations::CollectionProxy,
            ActiveForm::AssociationRelation,
          ]
        end

        def uncacheable_methods
          @uncacheable_methods ||= (
            delegated_classes.flat_map(&:public_instance_methods) - ActiveForm::Relation.public_instance_methods
          ).to_set.freeze
        end
      end
